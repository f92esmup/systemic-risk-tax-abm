...
def main():
    ...
    sns.kdeplot(data_none["losses"], ax=axes[0], label="No Tax", fill=True, log_scale=(True, False), color="red")
    sns.kdeplot(data_srt["losses"], ax=axes[0], label="SRT", fill=True, log_scale=(True, False), color="green")
    ...
    # C. Volumen
    sns.boxplot(data=[data_none["volumes"], data_tobin["volumes"], data_srt["volumes"]], ax=axes[2])
